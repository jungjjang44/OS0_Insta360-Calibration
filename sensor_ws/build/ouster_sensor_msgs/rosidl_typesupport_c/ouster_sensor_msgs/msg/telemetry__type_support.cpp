...
static const _Telemetry_type_support_symbol_names_t _Telemetry_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ouster_sensor_msgs, msg, Telemetry)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ouster_sensor_msgs, msg, Telemetry)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, ouster_sensor_msgs, msg, Telemetry)() {
  return &::ouster_sensor_msgs::msg::rosidl_typesupport_c::Telemetry_message_type_support_handle;
}

...
#include "ouster_sensor_msgs/msg/detail/telemetry__rosidl_typesupport_fastrtps_c.h"
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPORT_ouster_sensor_msgs
...
using _Telemetry__ros_msg_type = ouster_sensor_msgs__msg__Telemetry;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: countdown_thermal_shutdown
  {
    cdr << ros_message->countdown_thermal_shutdown;
  }

  // Field name: countdown_shot_limiting
  {
...
size_t get_serialized_size_ouster_sensor_msgs__msg__Telemetry(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Telemetry__ros_msg_type * ros_message = static_cast<const _Telemetry__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _Telemetry__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ouster_sensor_msgs__msg__Telemetry(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ouster_sensor_msgs
size_t max_serialized_size_ouster_sensor_msgs__msg__Telemetry(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ouster_sensor_msgs__msg__Telemetry;
    is_plain =
      (
...
static size_t _Telemetry__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ouster_sensor_msgs__msg__Telemetry(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ouster_sensor_msgs, msg, Telemetry)() {

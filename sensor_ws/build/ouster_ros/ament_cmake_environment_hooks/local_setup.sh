...
: ${AMENT_CURRENT_PREFIX:="/home/krri/OS0_Insta360-Calibration/sensor_ws/install/ouster_ros"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/ouster_ros/environment/library_path.sh"
